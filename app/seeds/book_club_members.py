...
def seed_book_club_members():
    ...
    member_seeds = [
        ...
        BookClubMember(book_club_id=2, user_id=1, created_at=datetime.now(), updated_at=datetime.now()),
        BookClubMember(book_club_id=1, user_id=1, created_at=datetime.now(), updated_at=datetime.now()),
        BookClubMember(book_club_id=3, user_id=2, created_at=datetime.now(), updated_at=datetime.now()),
        ...
        BookClubMember(book_club_id=6, user_id=3, created_at=datetime.now(), updated_at=datetime.now()),
        ...
        BookClubMember(book_club_id=8, user_id=4, created_at=datetime.now(), updated_at=datetime.now()),
        BookClubMember(book_club_id=10, user_id=4, created_at=datetime.now(), updated_at=datetime.now()),
        BookClubMember(book_club_id=7, user_id=4, created_at=datetime.now(), updated_at=datetime.now()),
        BookClubMember(book_club_id=9, user_id=5, created_at=datetime.now(), updated_at=datetime.now()),
        BookClubMember(book_club_id=10, user_id=5, created_at=datetime.now(), updated_at=datetime.now()),
        ...
        BookClubMember(book_club_id=8, user_id=6, created_at=datetime.now(), updated_at=datetime.now()),
        ...
        BookClubMember(book_club_id=8, user_id=12, created_at=datetime.now(), updated_at=datetime.now()),
